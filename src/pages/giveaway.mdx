...
<div className="md:flex">
  ...
  **This February, to celebrate the announcement of [Byteconf React](/react-2020), our free remote React conference, we're giving away the wildly popular Udemy course ["Modern React with Redux"](https://www.udemy.com/course/react-redux/), a 45+ hour course that will help you get up and running with React.js.**

  [!["Modern React with Redux"](https://i.udemycdn.com/course/480x270/705264_caa9_11.jpg)](https://www.udemy.com/course/react-redux/)

  Between now and February 28th, all you need to do is enter your email address below – we'll RSVP you for [Byteconf React 2020](/react-2020), and you'll have a chance to win ["Modern React with Redux"](https://www.udemy.com/course/react-redux/), a course valued at $180, for absolutely free!
  ...
  ** BYTESIZED GIVEAWAY OFFICIAL RULES **
  ...
  GIVEAWAY ENTRY PERIOD: The Giveaway period begins on Feb 1, 2020 at 12:00 AM EST and ends on Feb 28, 2020 at 11:59 PM EST ("Promotion Period"). All entries must be received during the Promotion Period.
  ...
  WINNER SELECTION: Winners will be selected in a random drawing ("Drawing"). The Drawing will take place within seven (7) days following the close of the Promotion Period. Odds of winning depend on the total number of eligible entries received.
