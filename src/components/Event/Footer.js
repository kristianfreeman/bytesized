    ...
    <div className="p-8 bg-orange-200 text-center">
      <div className="flex flex-wrap m-5 justify-center">
        <div className="w-full md:w-1/3 pb-4">
          <h4 className="text-2xl mb-4 font-bold">{event.name}</h4>
          <p>
            <DateString
        ...
        <div className="w-full md:w-1/3 pb-4">
          <h4 className="text-2xl mb-4 font-bold">Contact Us</h4>
          <p className="mb-4">
          ...
          <p className="pb-4">
            ...
            <a className="font-bold" href={event.sponsor_interest_link}>
